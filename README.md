...
It also contains portions of code from BioSTEAM, which is licensed under the University of Illinois/NCSA Open Source License.
Please refer to [`LICENSE`](LICENSE) and [`LICENSES/biosteam_license.txt](LICENSES/biosteam_license.txt).
