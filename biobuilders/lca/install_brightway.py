...
def import_ecoinvent(projectName='biobuilders', version="3.9.1", system_model="cutoff"):
...
if __name__ == "__main__":
    ...
    import_ecoinvent(projectName='biobuilders', version="3.9.1", system_model="cutoff")

    # Check the project database
    check_project_database(projectName='biobuilders')